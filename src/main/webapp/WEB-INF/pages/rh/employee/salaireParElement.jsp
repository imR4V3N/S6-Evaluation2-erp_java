                            ...
                            <div class="col-12">
                                <div class="card col-12">
                                    ...
                                    <div class="card-body col-12">
                                        <form class="col-12" action="<%=contextPath%>/salaire/element" method="get" >

                                            <div class="form-group" style="width: 80%;">
                                                <div class="form-group">
                                                    <label>Element</label>
                                                    <select name="element" class="form-control select2" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="comparaison" class="form-control select2" required>
                                                ...
                                                <div class="form-group" style="width: 80%;">
                                                    <label>Montant</label>
                                                    <input class="form-control" type="text" name="montant" value="0" required/>
                                                </div>
                                            </div>
